function [d, i, c] = cluster_sort(D,k,n,minC,nost)
...
if (m <= 2)
    ...
    if (k == 2)
        ...
        %i = optimalleaforder(l, pd, 'Criteria','group', 'Transformation','inverse');
        %i = optimalleaforder(l, pd, 'Criteria','adjacent', 'Transformation','inverse');
        i = optimalleaforder(l, pd, 'Criteria','group', 'Transformation','linear');
    end
end
d = D(i,:);
